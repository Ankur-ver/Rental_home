      ...
      <div class="col-md-2">
         <div class="float-right">
            <div class=" dropdown mr-4">
              <p></p>
                <a href="#" class="text-dark"  id="account_settings" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="assets/img/img.png" width="36" height="36" class="rounded-circle"></a>
